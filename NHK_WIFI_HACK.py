...
██╔══╝░░██╔══██║██║╚████║
██║░░░░░██║░░██║██║░╚███║
╚═╝░░░░░╚═╝░░╚═╝╚═╝░░╚══╝\n\t\t\033[1;36m 👑 NAIMUL HACKER 👑 
                                                    \n\t\t[\033[1;32m*\033[1;37m] NAME        : NAIMUL HAVKER \n\t\t[\033[1;32m*\033[1;37m] WORK ONLY   : GREEN-COLOR WIFI\n\t\t[\033[1;32m*\033[1;37m] AUTHOR      : Naimul \n\t\t[\033[1;32m*\033[1;37m] Version     : WIFI_HACK_2.0 \n\t\t[\033[1;32m*\033[1;37m] FACEBOOK    : @NHK NAIMUL HACKER 👑 \n''')
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] Create by NAIMUL HACKER.🐸😁…")
                    break
                else:
                    args.bssid = None
            else:
